...
cc.Class({
    ...
    linklinesetProgressBarColor(color){
        //return;
        for(let i = 0;i < 6;i++){
    ...
    linklineprogressAct1(){
        if(this.num == 0 || this.num == 1){
            if(this.progress1.children[0].getComponent(cc.ProgressBar).progress >= 0)
    ...
    linklinesetProgressBar(num){
        ...
        if(num == 0 || num == 1){
            ...
            if(num == 8 && this.numBk < num)
                this.audioMgr.linklineplayClose2();
            this.schedule(this.linklineprogressAct1,0.01);
        }
