(function() {"use strict";var __module = CC_EDITOR ? module : {exports:{}};var __filename = 'preview-scripts/assets/myScripts/linklinedataMgr.js';var __require = CC_EDITOR ? function (request) {return cc.require(request, require);} : function (request) {return cc.require(request, __filename);};function __define (exports, require, module) {"use strict";
cc._RF.push(module, '46859ix9U1Di5yJeW+DRFEj', 'linklinedataMgr', __filename);
// myScripts/linklinedataMgr.js
...
DataMgr.colorMgr = {
    linklinegetColorById: function linklinegetColorById(id) {
        for (var i = 0; i < myRGB.length; i++) {
            if (myRGB[i].id === id) return myRGB[i].color;
        }
        return null;
    },
    linklinegetColorByIndex: function linklinegetColorByIndex(index) {
        if (index < 0 || index >= myRGB.length) return null;
        return myRGB[index].color;
    },
    linklinegetColorLength: function linklinegetColorLength() {
        return myRGB.length;
    },

    linklinegetCircleColorByIndex: function linklinegetCircleColorByIndex(index) {
        for (var i = 0; i < circleColor.length; i++) {
            if (circleColor[i].index == index) return circleColor[i].color;
        }
    },
    linklinegetCircleColorLength: function linklinegetCircleColorLength() {
...
cc._RF.pop();
        ...
        //# sourceMappingURL=linklinedataMgr.js.map
